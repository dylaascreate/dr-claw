    ...
    >
      ...
      <div className="px-5 pb-3 border-b border-brown-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-brown-500 mt-0.5">Pick a condition to open its dedicated page.</p>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-6 text-left">
        ...
        <Link
          to="/conditions/$slug"
          params={{ slug: CONDITIONS[0].slug }}
          onClick={onClose}
          className="block w-full text-left relative bg-gradient-to-tr from-sage-500 to-terracotta-500 text-white rounded-3xl p-5 overflow-hidden shadow-soft hover:shadow-md transition-shadow active:scale-[0.99]"
        >
